...
const NavBar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        <Link to='/'>
            <h1 className='w-36'>MERN E-Commerce</h1>
        </Link>
        <ul className='hidden gap-5 text-sm text-gray-700 sm:flex'>
            ...
            {/* Added Admin Login link to main navigation */}
            <a 
                href={import.meta.env.ADMIN_LOGIN_URL} 
            ...
            <div className='relative group'>
                ...
                <div className='absolute right-0 hidden pt-4 group-hover:block dropdown-menu'>
                    <div className='flex flex-col gap-2 px-5 py-3 text-gray-500 rounded w-36 bg-slate-100'>
                        ...
                        <a className='cursor-pointer hover:text-black' href={import.meta.env.ADMIN_LOGIN_URL}>Admin Login</a>
                    </div>
                </div>
            </div>
